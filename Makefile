...
#    Updated: 2016/06/26 12:32:02 by kchetty          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = $(PATH_SRC)main.c $(PATH_SRC)get_map.c $(PATH_SRC)controls.c \
	  $(PATH_SRC)errors.c $(PATH_SRC)raycast.c $(PATH_SRC)ft_colors.c

OBJ = main.o get_map.o controls.o errors.o raycast.o ft_colors.o
